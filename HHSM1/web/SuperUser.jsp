  ...
  <br>
	<div class="container">
		<div class="jumbotron  ">
			...
			<form class="form-group" action="<%=request.getContextPath()%>/SuperUserLogin" method="post">

				<label for="username">Username:</label> <input type="text"
					class="form-control" required name="username" placeholder="Username">
...
insert into superuser(username,password) values("ayushjha","qwerty@123");
